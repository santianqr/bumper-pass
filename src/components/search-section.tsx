...
export default function SearchSection({ id }: Props) {
  return (
    <section id={id} className="flex flex-col items-center space-y-8 pt-12">
      <h2 className="col-span-2 scroll-m-20 text-3xl font-semibold tracking-tight first:mt-0">
        Search Now!
      </h2>
      <div className="grid max-w-screen-lg grid-cols-2 items-center justify-items-center gap-4">
